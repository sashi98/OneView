...
public class BuildStatusCellRenderer extends CJPanel implements TableCellRenderer{
    private JComponent component;

    public BuildStatusCellRenderer() {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (BUILD_SUCCESS == valueOfValue) {
            component = BUILD_SUCCESS_IP;
        }
        if (BUILD_FAILED == valueOfValue) {
            component = BUILD_FAILED_IP;
        }
